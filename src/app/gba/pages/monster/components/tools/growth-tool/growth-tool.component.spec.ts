...
import { GrowthToolComponent } from './growth-tool.component';

describe('GrowthToolComponent', () => {
  ...
  let component: GrowthToolComponent;
  let fixture: ComponentFixture<GrowthToolComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ GrowthToolComponent ]
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(GrowthToolComponent);
