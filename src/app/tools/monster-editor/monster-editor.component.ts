...
import { Monster, MonsterService } from 'src/app/services/monster.service';
import { PendingChange, RomService } from 'src/app/services/rom.service';

@Component({
  selector: 'app-monster-editor',
  templateUrl: './monster-editor.component.html',
  styleUrls: ['./monster-editor.component.css']
})
export class MonsterEditorComponent implements OnInit {
  ...
  public setCurrent(monster: Monster) {
    ...
    this.frontNormalSprite = this.monsterService.loadBattleSprite(this.currentMonster.uid, true, false);
    this.backNormalSprite = this.monsterService.loadBattleSprite(this.currentMonster.uid, false, false);
    this.frontShinySprite = this.monsterService.loadBattleSprite(this.currentMonster.uid, true, true);
    this.backShinySprite = this.monsterService.loadBattleSprite(this.currentMonster.uid, false, true);
  }
