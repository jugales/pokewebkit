...
import { BattleStatsToolComponent } from './battle-stats-tool.component';

describe('BattleStatsToolComponent', () => {
  ...
  let component: BattleStatsToolComponent;
  let fixture: ComponentFixture<BattleStatsToolComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ BattleStatsToolComponent ]
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(BattleStatsToolComponent);
