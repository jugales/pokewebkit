...
import { BitmapPalette, BitmapPixelData, BitmapPixelDepth, BitmapService } from '../graphics/bitmap.service';
...
export class TrainerService {
  ...
  public loadSprite(trainerId: number, hasTransparency?: boolean) {
    let pixelStart = 0;
    let paletteStart = 0;
    ...
    return this.bitmapService.createBitmap(pixelObj, paletteObj, 64, 64, hasTransparency);
  }
}
