...
import { EvToolComponent } from './ev-tool.component';

describe('EvToolComponent', () => {
  ...
  let component: EvToolComponent;
  let fixture: ComponentFixture<EvToolComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ EvToolComponent ]
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(EvToolComponent);
