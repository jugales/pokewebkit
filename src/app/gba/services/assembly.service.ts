...
export class AssemblyService {
  ...
  public applyTileAnimationAssembly(address: number) {
    if (this.romService.header.gameCode == 'BPRE' && this.romService.header.version == 0) {

      // check if script already applied, if so, return; ensures compatibility with existing rom changes
      this.romService.goTo(0x70000);
      let flagValue = this.romService.getInt();
      let flag = this.romService.constants().MAP_TILESET_ANIMATION_FLAG;
      if (flagValue !== flag)
        return;

      this.romService.goTo(0x6FFCC);
      this.romService.writeBytes(this.tileAnimationReplacementScript, true);
      this.romService.writePointer(address, true);
      this.romService.writeBytes(this.tileAnimationReplacementScriptFiller, true);
  
      this.romService.goTo(0x7004E);
      this.romService.writeInt(0, true);
  
      this.romService.goTo(0x7008A);
      this.romService.writeInt(0, true);
  
      this.romService.goTo(address);
      this.romService.writeBytes(this.tileAnimationAssemblyScriptBPRE0, true);
  
      let scriptStart = address + 1;

      this.romService.goTo(0x70000);
      this.romService.writePointer(scriptStart, true);

      this.romService.goTo(0x2D4AA4);
      this.romService.writePointer(address + 324, true);
      
      this.romService.goTo(0x2D4B4C);
      this.romService.writePointer(address + 372, true);
  
      this.romService.goTo(0x2D4D44);
      this.romService.writePointer(address + 388, true);
  
      this.romService.goTo(0x2D4D5C);
      this.romService.writePointer(address + 404, true);
  
      this.romService.goTo(0x2D4EDC);
      this.romService.writePointer(address + 420, true);
  
      this.romService.goTo(0x2D4FFC);
      this.romService.writePointer(address + 436, true);
    } else if (this.romService.header.gameCode == 'BPRE' && this.romService.header.version == 1) {
      // check if script already applied, if so, return; ensures compatibility with existing rom changes
      this.romService.goTo(0x70014);
      let flagValue = this.romService.getInt();
      let flag = this.romService.constants().MAP_TILESET_ANIMATION_FLAG;
      if (flagValue !== flag) {
      ...
      this.romService.goTo(0x6FFE0);
      this.romService.writeBytes(this.tileAnimationReplacementScript, true);
      this.romService.writePointer(address, true);
      this.romService.writeBytes(this.tileAnimationReplacementScriptFiller, true);
  
      this.romService.goTo(0x70062);
      this.romService.writeInt(0, true);
  
      this.romService.goTo(0x7009E);
      this.romService.writeInt(0, true);
  
      this.romService.goTo(address);
      this.romService.writeBytes(this.tileAnimationAssemblyScriptBPRE1, true);
      ...
      this.romService.goTo(0x2D4B14);
      this.romService.writePointer(address + 324, true);
      
      this.romService.goTo(0x2D4BBC);
      this.romService.writePointer(address + 372, true);
  
      this.romService.goTo(0x2D4DB4);
      this.romService.writePointer(address + 388, true);
  
      this.romService.goTo(0x2D4DCC);
      this.romService.writePointer(address + 404, true);
  
      this.romService.goTo(0x2D4F4C);
      this.romService.writePointer(address + 420, true);
  
      this.romService.goTo(0x2D506C);
      this.romService.writePointer(address + 436, true);
    } else if (this.romService.header.gameCode == 'BPEE') {

      // check if script already applied, if so, return; ensures compatibility with existing rom changes
      this.romService.goTo(0xA0A7C);
      let flagValue = this.romService.getInt();
      let flag = this.romService.constants().MAP_TILESET_ANIMATION_FLAG;
      if (flagValue !== flag) {
        console.log('script already applied!');
      ...
      this.romService.goTo(0xA0A48);
      this.romService.writeBytes(this.tileAnimationReplacementScript, true);
      this.romService.writePointer(address, true);
      this.romService.writeBytes(this.tileAnimationReplacementScriptFiller, true);
  
      this.romService.goTo(0xA0ACA);
      this.romService.writeInt(0, true);
  
      this.romService.goTo(0xA0B06);
      this.romService.writeInt(0, true);
  
      this.romService.goTo(address);
      this.romService.writeBytes(this.tileAnimationAssemblyScriptBPEE, true);
      ...
      this.romService.goTo(0x3DF718);
      this.romService.writePointer(address + 319 + 1, true);
      
      this.romService.goTo(0x3DF730);
      this.romService.writeInt(0, true);
  
      this.romService.goTo(0x3DF748);
      this.romService.writePointer(address + 399 + 1, true);
  
      this.romService.goTo(0x3DF760);
      this.romService.writePointer(address + 543 + 1, true);
  
      this.romService.goTo(0x3DF778);
      this.romService.writePointer(address + 559 + 1, true);

      this.romService.goTo(0x3DF790);
      this.romService.writePointer(address + 575 + 1, true);

      this.romService.goTo(0x3DF7A8);
      this.romService.writePointer(address + 1087 + 1, true);

      this.romService.goTo(0x3DF7C0);
      this.romService.writeInt(0, true);

      this.romService.goTo(0x3DF7D8);
      this.romService.writeInt(0, true);

      this.romService.goTo(0x3DF7F0);
      this.romService.writeInt(0, true);

      this.romService.goTo(0x3DF808);
      this.romService.writeInt(0, true);

      this.romService.goTo(0x3DF820);
      this.romService.writePointer(address + 1135 + 1, true);

      this.romService.goTo(0x3DF838);
      this.romService.writePointer(address + 1263 + 1, true);

      this.romService.goTo(0x3DF850);
      this.romService.writePointer(address + 1295 + 1, true);

      this.romService.goTo(0x3DF868);
      this.romService.writePointer(address + 1311 + 1, true);

      this.romService.goTo(0x3DF880);
      this.romService.writePointer(address + 1327 + 1, true);

      this.romService.goTo(0x3DF898);
      this.romService.writePointer(address + 1343 + 1, true);

      this.romService.goTo(0x3DF8E0);
      this.romService.writePointer(address + 1359 + 1, true);

      this.romService.goTo(0x3DF9E8);
      this.romService.writePointer(address + 1375 + 1, true);

      this.romService.goTo(0x3DFB38);
      this.romService.writePointer(address + 1391 + 1, true);

      this.romService.goTo(0x3DFB68);
      this.romService.writePointer(address + 1407 + 1, true);

      this.romService.goTo(0x3DFBE0);
      this.romService.writePointer(address + 1439 + 1, true);

      this.romService.goTo(0x3DFC90);
      this.romService.writePointer(address + 1455 + 1, true);

      this.romService.goTo(0x3DFCD8);
      this.romService.writePointer(address + 1487 + 1, true);

      this.romService.goTo(0x3DFD38);
      this.romService.writePointer(address + 1503 + 1, true);
    }
  }
}
